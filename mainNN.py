...
def main():
    ...
    for i, outer_fold in enumerate(folds):
       ...
       # Train the network using Particle Swarm Optimization
        network, fold_performance = PSwarm.train_network(training_folds, numOutput, label_index, is_classification=True)
    ...
    winsound.Beep(540, 1000)  # Frequency: 440 Hz, Duration: 500 milliseconds so i can leave it run and do other thinfs 
